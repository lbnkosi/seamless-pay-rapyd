...
part of 'payments_struct.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<PaymentsStruct> _$paymentsStructSerializer =
    new _$PaymentsStructSerializer();

class _$PaymentsStructSerializer
    implements StructuredSerializer<PaymentsStruct> {
  @override
  final Iterable<Type> types = const [PaymentsStruct, _$PaymentsStruct];
  @override
  final String wireName = 'PaymentsStruct';

  @override
  Iterable<Object?> serialize(Serializers serializers, PaymentsStruct object,
  ...
  @override
  PaymentsStruct deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PaymentsStructBuilder();
...
class _$PaymentsStruct extends PaymentsStruct {
  @override
  final String? link;
  @override
  ...
  factory _$PaymentsStruct([void Function(PaymentsStructBuilder)? updates]) =>
      (new PaymentsStructBuilder()..update(updates))._build();
  ...
  _$PaymentsStruct._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        firestoreUtilData, r'PaymentsStruct', 'firestoreUtilData');
  }

  @override
  PaymentsStruct rebuild(void Function(PaymentsStructBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PaymentsStructBuilder toBuilder() =>
      new PaymentsStructBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PaymentsStruct &&
        link == other.link &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PaymentsStruct')
          ..add('link', link)
...
class PaymentsStructBuilder
    implements Builder<PaymentsStruct, PaymentsStructBuilder> {
  _$PaymentsStruct? _$v;
  ...
  PaymentsStructBuilder() {
    PaymentsStruct._initializeBuilder(this);
  }

  PaymentsStructBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _link = $v.link;
  ...
  @override
  void replace(PaymentsStruct other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PaymentsStruct;
  }

  @override
  void update(void Function(PaymentsStructBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PaymentsStruct build() => _build();

  _$PaymentsStruct _build() {
    final _$result = _$v ??
        new _$PaymentsStruct._(
            link: link,
            walletId: walletId,
            paymentId: paymentId,

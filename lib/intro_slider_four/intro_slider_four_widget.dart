...
class IntroSliderFourWidget extends StatefulWidget {
  const IntroSliderFourWidget({Key? key}) : super(key: key);

  @override
  _IntroSliderFourWidgetState createState() => _IntroSliderFourWidgetState();
}

class _IntroSliderFourWidgetState extends State<IntroSliderFourWidget> {
